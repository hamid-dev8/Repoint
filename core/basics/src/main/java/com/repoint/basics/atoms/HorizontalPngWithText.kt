...
fun PreviewPng() {
    ...
    PngWithText(com.repoint.dependencies.R.drawable.orglogo, "desc", "re-Point", repointOrange,Modifier)
...
fun PngWithText(png: Int, desc: String, text: String, textColor: Color,modifier: Modifier) {
    ...
    Row() {
        ...
        Image(
            ...
            modifier = modifier
                .size(52.dp).padding(start = 8.dp).align(Alignment.CenterVertically),
...
@Composable
fun BigPng(png: Int,modifier: Modifier = Modifier) {
